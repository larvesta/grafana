...
var TRANSLATE_ZH = {
  ...
  'Stats': '统计概述',
  'Value': '值',
  'Total dashboards': '主页数量',
  'Total users': '用户数量',
  'Total organizations': '用户组数量',
  'Total datasources': '数据源数量',
  'Total playlists': '主页列表数量',
  'Total snapshots': '快照数量',
  'Total dashboard tags': '主页标签数量',
  'Total starred dashboards': '受关注主页数量',
  'Login': '登录号',
  'Admin': '管理员',
  'Adding an Alert': '添加告警',
  'Go to Home Dashboard': '跳转到管理员页面',
  ...
  'Back to dashboard': '回到主页',
  'Cancel': '取消',
  'Import Dashboard': '导入主页',
  'Load': '加载',
  'Global Alerts': '全局告警',
  'Filters': '筛选',
  'Alert State': '告警状态',
  ...
  'New name': '新名称',
  'Import': '导入',
  'Migrate dashboards': '数据源迁移主页',
  'List dashboards': '主页列表',
  'Load dashboard from Graphite-Web': '从Graphite-Web加载主页',
  'Online': '上线',
  'Time range': '时间范围',
  'From': '开始',
  'To': '结束',
  ...
  'Continue': '继续',
  'Ignore': '忽略',
  'Manage dashboard': '主页管理',
  'Open editView of dashboard': '打开主页编辑视图',
  'Save dashboard': '保存主页',
  'Open original dashboard': '打开原始主页',
  'No matching': '无符合记录',
  'Max shown': '最大显示',
  'Snapshot name': '快照名称',
  'Expire': '期限',
